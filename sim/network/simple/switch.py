...
class SwitchInterface(MessageInterface):
    def __init__(self, sim, compo, interface_id):
        super(SwitchInterface, self).__init__(sim, compo, interface_id)
...
class Network(MessageBus):
    def __init__(self, sim, compo, config: BusConfig = None):
        super(Network, self).__init__(sim, compo, config)
